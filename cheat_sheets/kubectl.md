...
Set which Kubernetes cluster `kubectl` communicates with and modifies configuration information. See [Authenticating Across Clusters with kubeconfig documentation](https://kubernetes.io/docs/tasks/access-application-cluster/configure-access-multiple-clusters/) for detailed config file information.
...
A detailed list of kubectl commands can be found here: <https://kubernetes.io/docs/reference/generated/kubectl/kubectl-commands>
